...
<div class="w3-top" style="font-family: Times New Roman, Times, serif;
  ...
  <div class="w3-bar w3-black w3-wide w3-padding w3-card">
    <a href="admin.php" class="w3-bar-item w3-button"><b>SMKS2</b> Kelab</a>
...
<div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
  ...
  <div class="w3-panel" style="font-family: Times New Roman, Times, serif;
    ...
    font-size: 40px;"><b>Kehadiran</b></h1>
    <p>kehadiran ahli yang hadir aktiviti tersebut</p>
  </div>
  ...
  <div class="form-container sign-up-container">
		<form action="#" method="post">
			<h1 style="font-family: Times New Roman, Times, serif;
    font-size: 40px;">Delete Kehadiran</h1>
