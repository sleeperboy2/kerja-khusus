...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center"  style="font-family: Times New Roman, Times, serif;
    font-size: large;">
    <h1 class="w3-xxlarge w3-text-white" style="font-family: Times New Roman, Times, serif;
    font-size: large;"><span class="w3-padding w3-black w3-opacity-min"><b>BR</b></span> <span class="w3-hide-small w3-text-light-grey">Architects</span></h1>
  </div>
</header>
