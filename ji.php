...
<html>
<head>
<title>Kelab Komputer</title>
<link rel="stylesheet" href="csslogin3.css">
</head>
<div class="container" id="container">
  <div class="form-container sign-up-container">
    <form action="#" method="post">
      <h1>Pendaftaran Baharu</h1>
      <input type="text" name="user" placeholder="ID Admin" />
  ...
  //Ini adalah paparan log masuk admin 
  <div class="form-container sign-in-container">
    <form action="#" method="post">
      <h1>Log Masuk Admin</h1>
      <input type="text" name="user" placeholder="ID Admin" minlength='12' maxlength='13' required/>
      <input type="password" name="pass" placeholder="Kata Laluan" />
